...
void Vhello___024root___nba_sequent__TOP__0(Vhello___024root* vlSelf);
void Vhello___024root___nba_sequent__TOP__1(Vhello___024root* vlSelf);
void Vhello___024root___nba_comb__TOP__0(Vhello___024root* vlSelf);
...
void Vhello___024root___eval_nba(Vhello___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vhello___024root___nba_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vhello___024root___nba_sequent__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[3U] = 1U;
    }
    if ((3ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vhello___024root___nba_comb__TOP__0(vlSelf);
...
#endif
                VL_FATAL_MT("src/code/core_als.sv", 19, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("src/code/core_als.sv", 19, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("src/code/core_als.sv", 19, "", "NBA region did not converge.");
            }
